...
export default function CollectiblesDetails() {
  ...
  return (
    <div className='md:max-w-full sm:max-w-[385px] px-2 mx-auto bg-[#0d0f0e] relative'>
      <HeaderDetails />
        ...
        <div className='flex flex-row md:flex md:flex-col gap-y-2 justify-center items-end mr-10'>
          {character.images.map((image, index) => (
            <img
              ...
              src={image}
              className={`sm:w-12 w-8 aspect-square sm:h-[70px] h-[40px] object-scale-down cursor-pointer p-1 hover:scale-105 hover:brightness-105 duration-200 transition-all ease-in-out overflow-hidden ${
        ...
        <div className='flex flex-row md:gap-x-8 gap-x-4'>
          <div className='md:w-[400px] md:p-4 p-3'>
            ...
            <div className='flex flex-col mb-10'>
              ...
              <p className='text-lightgray text-[12px] leading-[24px] uppercase exo-2'>{character.anime}</p>
            </div>
            <div className='flex flex-row md:gap-x-8 gap-x-4'>
