export default function Footer() {
  return (
    <div className='flex flex-col w-full justify-center py-6 bg-darkbg'>
      <div className='md:mb-16 mb-32 md:border-[#1f1e1e] md:border-t pt-px justify-items-center w-full rounded bg-gradient-to-r from-[#0c0c0c] via-[#504d4d] to-[#0c0c0c]'>
        <div className='h-full w-full bg-darkbg pt-4 px-4'>
          <p className='text-[12.5px] w-auto md:w-[1000px] md:pl-32 pl-6 text-tight text-lightgray montserrat mb-10 md:mb-4 px-6 md:px-0 leading-5'>
