  ...
  return (
    <header className='flex flex-col justify-center items-center'>
        <div className='flex flex-row hover:cursor-pointer items-center py-2'>
          <h1 className='text-lg font-kanji'>こんにちは</h1>
          <img
            src={Bowing}
            className='w-16 h-12'
            alt='Bowing man'
      ...
      <div className='bg-gradient-to-r from-[#fffdfd] to-[#f9fff9] w-[935px] h-[235px] text-lg md:px-2 md:py-3 py-10 px-4 md:rounded-md md:shadow-sm hover:scale-105 duration-300 ease-in'>
        <h1 className='text-[#111] text-xl font-robotoo tracking-[1.05px]'>
          Authentic Products from
          <span className='text-[#fb2020]'> JAPAN</span>
        </h1>
        <h1 className='text-[#111] text-balance pt-4 font-robotoo'>
        ...
        <p className='text-[#111] text-balance pt-4 font-robotoo'>
        ...
        <div className='flex flex-row items-center'>
          <a
            ...
            <svg
              ...
              className='object-contain fill-black transition ease-in-out duration-200 hover:fill-[#fb2020]'
              x='0px'
              y='0px'
              width={40}
              height={40}
          ...
          <span className='ml-2 transition ease-in-out duration-200 hover:text-[#fb2020] font-robotoo cursor-pointer tracking-tighter text-md'>
            +1 910-318-9001
          </span>
        </div>
      </div>
