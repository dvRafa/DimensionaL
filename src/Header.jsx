...
function Header() {
  return (
    <header className='flex flex-col justify-center items-center'>
      <div className='flex flex-grow items-center justify-center pt-1 pb-4'>
        <h1 className='font-bold text-xl font-robotoo hover:cursor-pointer'>こんにちは</h1>
        <img
          src={Bowing}
      ...
      <div className='bg-[#222] text-lg md:py-12 py-10 px-4 md:px-36'>
        <h1 className='text-[hsl(210,13%,97%)] text-pretty uppercase text-3xl font-roboto'>
          Authentic products from
          <span className='text-[#eaa224]'> Japan</span>
        </h1>
        <h1 className='text-[#f6f7f8] text-balance md:text-pretty pt-4 font-robotoo'>
        ...
        <p className='text-[#f6f7f8] text-balance md:text-pretty pt-2 font-robotoo'>Please be aware that the <span className='text-[#cc2020]'>Levi Ackerman</span> and <span className='text-[#cc2020]'>Monkey D. Luffy</span> figures come without a box. Each figure is shipped with only the figure itself and a base for display.</p>
        <div className='flex flex-row pt-8 items-center'>
          ...
          <span className='ml-2 text-[#f6f7f8] transition ease-in-out duration-200 hover:text-[#a70404] font-robotoo cursor-pointer tracking-tighter text-md'>
            +1 910-318-9001
          </span>
        </div>
      </div>
